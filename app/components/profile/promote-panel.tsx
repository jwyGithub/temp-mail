            ...
            <div className='space-y-4'>
                <div className='flex gap-4'>
                    <div className='flex-1'>
                        <Input value={searchText} onChange={e => setSearchText(e.target.value)} placeholder={t('searchPlaceholder')} />
                    </div>
                ...
                <Button onClick={handleAction} disabled={loading || !searchText.trim()} className='w-full'>
                    {loading ? <Loader2 className='w-4 h-4 animate-spin' /> : `${t('promote')} ${roleNames[targetRole]}`}
                </Button>
            </div>
        </div>
    );
