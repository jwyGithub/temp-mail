    ...
    const fetchEmails = async (cursor?: string) => {
        try {
            ...
            if (!cursor) {
                ...
                const lastDuplicateIndex = newEmails.findIndex(newEmail => oldEmails.some(oldEmail => oldEmail.id === newEmail.id));
            ...
            <div className='flex flex-col h-full'>
                ...
                <div className='flex-1 overflow-auto p-2' onScroll={handleScroll}>
                    {loading ? (
                        ...
                        <div className='text-center text-sm text-gray-500'>还没有邮箱，创建一个吧！</div>
                    )}
                </div>
            </div>
