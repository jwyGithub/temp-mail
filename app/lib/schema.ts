...
export const siteConfig = sqliteTable('site_config', {
    id: text('id')
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
    defaultRole: text('default_role').notNull().default(ROLES.CIVILIAN),
    emailDomains: text('email_domains').notNull().default(''),
    adminContacts: text('admin_contacts').notNull().default(''),
    maxEmails: integer('max_emails').notNull().default(EMAIL_CONFIG.MAX_ACTIVE_EMAILS)
});
