            ...
            <DialogContent>
                ...
                <div className='space-y-4 py-4'>
                    <div className='flex gap-2'>
                        <Input value={emailName} onChange={e => setEmailName(e.target.value)} placeholder='输入邮箱名' className='flex-1' />
                        ...
                        <Button variant='outline' size='icon' onClick={generateRandomName} type='button'>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <RadioGroup value={expiryTime} onValueChange={setExpiryTime} className='flex gap-6'>
                    ...
                    <div className='flex items-center gap-2 text-sm text-muted-foreground'>
                        ...
                        {emailName ? (
                            <div className='flex items-center gap-2 min-w-0'>
                                ...
                                <div className='shrink-0 cursor-pointer hover:text-primary transition-colors' onClick={copyEmailAddress}>
