                    ...
                    <div className='h-[calc(100vh-4rem)] flex flex-col items-center justify-center text-center px-4 relative'>
                        ...
                        <div className='w-full max-w-3xl mx-auto space-y-12 py-8'>
                            <div className='space-y-4'>
                                ...
                                <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-300 tracking-wide'>临时邮箱服务</p>
                            </div>

                            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4 sm:px-0'>
                                <FeatureCard icon={<Shield className='w-5 h-5' />} title='隐私保护' description='保护您的真实邮箱地址' />
                                <FeatureCard icon={<Mail className='w-5 h-5' />} title='即时收件' description='实时接收邮件通知' />
                                <FeatureCard icon={<Clock className='w-5 h-5' />} title='自动过期' description='到期自动失效' />
                            </div>
